...
cv2.imshow('vertical_mask.png', mask)
# ------ 
...
cv2.imshow('horizontal_mask.png', horizontal_mask)
# ------ 
...
cv2.imshow('remove_vertical.png', remove_vertical)
cv2.imshow('remove_horizontal.png', remove_horizontal)
cv2.imshow('dilate_horizontal.png', dilate_horizontal)
