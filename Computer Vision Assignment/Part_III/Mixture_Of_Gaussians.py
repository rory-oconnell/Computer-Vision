...
for t in range(MAX_FRAMES):
    ...
    # Draw a red vertical line down the center of the image
    ...
    for contour in contours:
        ...
        if cv2.countNonZero(ball_color_mask) > 0:
            ...
            print(f"Ball center location: ({center_x}, {center_y})")  # Print the center location
    ...
    key = cv2.waitKey(0)  # Delay of 30ms between frames
